...
Public Class Pcreate
    ...
    GroupBox1.Controls.OfType(Of RadioButton)().FirstOrDefault(Function(radioButton) radioButton.Checked)
        Dim command As New SqlCommand("insert into Passportdetails(FirstName,
LastName,DOB,Gender,Age,HouseNo,Street,Town,District,State,Pincode,Mailid
,Mobno,Pid,Fingerprint)values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & DateTimePicker1.Text & "',
...
,'" & Label17.Text & "',@img)", connection1)
    ...
    Private Sub Pcreate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
